...
export function CommandPalette({ onClose, onRun, onOpenSettings, onOpenMemory }: {
  ...
  const commands: Cmd[] = [
    ...
    { label: "What's the news?", hint: "copilot", run: () => onRun("what's the news") },
    { label: "Start a focus session (25 min)", hint: "copilot", run: () => onRun("start a focus session for 25 minutes") },
    { label: "End focus session", hint: "copilot", run: () => onRun("end focus session") },
